// lib/data/legacy-profiler.ts
// Original localStorage-based profiler that powers the premium frontend
// (onboarding wizard, dashboard, portfolio pages). Kept separate from the new
// Supabase-backed lib/profiler.ts so both can coexist during the migration.
...
export const PROFILES: Record<InvestorProfile, ProfileInfo> = {
  conservador: {
    ...
    explanation:
      'Tu prioridad es proteger lo que tenés. Preferís rendimientos modestos pero estables antes que arriesgarte a perder capital.',
    whatMeans: [
  ...
  estable: {
    ...
    explanation:
      'Querés que tu capital crezca por encima de la inflación, aceptando algo de volatilidad.',
    whatMeans: [
  ...
  moderado: {
    ...
    explanation:
      'Estás dispuesto a tolerar oscilaciones a cambio de mayor potencial de crecimiento.',
    whatMeans: [
  ...
  agresivo: {
    ...
    explanation:
      'Tu objetivo es maximizar el crecimiento del capital y aceptás caídas fuertes en el camino.',
    whatMeans: [
